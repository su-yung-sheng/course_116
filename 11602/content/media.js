...
window.MEDIA_AI = [
 {
  ...
  "goals": [
   ...
   "知道「生成式 AI」會產生新的文字、圖片、影片，有些 AI 還看得懂照片"
  ],
  "plan": [
   [
    "sort",
 ...
 },
 {
  ...
  "link": "直接用在：步驟 1 請 AI 看照片找特色、步驟 2 三句文案的提示詞 A（發想）與 B（檢查）"
 },
 {
  "id": "A4",
  "icon": "🔍",
  ...
  "link": "直接用在：步驟 2「每句不超過 15 字，避免誇大」與提示詞 B"
 },
 {
  "id": "A5",
  "icon": "⚖️",
  ...
  "goals": [
   "不把個資（姓名、人臉照片、學校、電話）輸入 AI；拍主角照片給 AI 時避開人臉和名牌",
   "作品要說清楚「哪些地方用了 AI」",
  ...
  "link": "直接用在：步驟 1 拍照給 AI、步驟 3 出鏡同意、步驟 4 音樂授權、步驟 5 AI 使用聲明"
 },
 {
  "id": "A6",
  "icon": "👀",
